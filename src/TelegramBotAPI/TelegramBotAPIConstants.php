 ...
 */
final class TelegramBotAPIConstants {

    const HTML_PARSE_MODE = 'HTML';
    const MARKDOWN_PARSE_MODE = 'Markdown';

    const TYPING_TYPE_ACTION = 'typing';
    const UPLOAD_PHOTO_TYPE_ACTION = 'upload_photo';
    const RECORD_VIDEO_TYPE_ACTION = 'record_video';
    const UPLOAD_VIDEO_TYPE_ACTION = 'upload_video';
    const RECORD_AUDIO_TYPE_ACTION = 'record_audio';
    const UPLOAD_AUDIO_TYPE_ACTION = 'upload_audio';
    const UPLOAD_DOCUMENT_TYPE_ACTION = 'upload_document';
    const FIND_LOCATION_TYPE_ACTION = 'find_location';
